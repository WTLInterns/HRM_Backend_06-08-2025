...
```bash
curl -X GET "http://localhost:8080/api/employee/2/558/salary-slip?startDate=2025-01-01&endDate=2025-01-31"
```

### Get all certificates for employee 558:
```bash
curl -X GET "http://localhost:8080/api/certificate/get/2/558"
```

### Upload experience certificate:
```bash
curl -X POST "http://localhost:8080/api/certificate/send/2/558/experience" \
